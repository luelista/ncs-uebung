...
\\ \hline
&TCP&    TCP beschreibt Funktionen für die Transportschicht, also die Kommunikation zwischen Prozessadressierung,
\\ \cline {2-2}
...
\\ \cline {2-2}
Datalink &STP& Fehlererkennung, außerdem die Aufteilung des gemeinsam genutzten Mediums
\\ \cline {2-2}
...
\\ \cline {2-2}
&IEEE 802.11 WiFi (physical layer)& Wellen im 2,4GHz bzw 5GHz-Band durchgeführt wird.
\\ \hline
\end{tabular}
\end{center}
\section{}
