...
\subsection{3.1.4}
Sobald B und E merken, dass ihre Verbindung unterbrochen ist, werden sie ihren Nachbarknoten Update Messages senden, bei denen ihre Route zum jeweils anderen als Kosten \8 eingetragen hat. Knoten A wird dann eine neue Minimalroute zu B haben, nämlich mit Kosten 7 via B, und seinerseits eine Update Message senden. Nach zwei Iterationen können also alle Knoten ihre Pakete über A nach B routen. 
